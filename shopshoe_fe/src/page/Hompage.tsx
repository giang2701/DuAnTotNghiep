                        ...
                        <div className="carousel-inner">
                            ...
                            >
                                ...
                                <div className="carousel-caption slide-up">
                                    ...
                                    <h1>
                                        Step into Style with Our Latest Shoe
                                        Collection
                                    </h1>
                                    <p className="describe">
                                        Explore our exclusive range of trendy
                                        sneakers designed for comfort and style.
                                        Find the perfect pair to express your
                                        unique personality!
                                    </p>
                        ...
                        <div className="sub_shipping container text-center ">
                            ...
                            >
                                ...
                                <div className="Free_shipping">
                                    ...
                                    <p>Free shipping</p>
                                    <p>
                                        Enjoy easy ordering with the premium
                                        quality of our sneakers.
                                    </p>
                                </div>
                                {/* 2 : 15 days returns */}
                                <div className="days_returns ">
                                    ...
                                    <p>15 days returns</p>
                                    <p>
                                        Order with ease and enjoy the freshness
                                        of our premium sneakers.
                                    </p>
                                </div>
                                ...
                                <div className="Secure_checkout">
                                    ...
                                    <p>Secure checkout</p>
                                    <p>
                                        If you get rotten items - return
                                        immediately to us.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="about container-fluid" id="about">
                        ...
                        <div className="row">
                            ...
                            <div className="content p-4">
                                <h3>why choose us?</h3>
                                <p>
                                    At Zokong, we pride ourselves on delivering
                                    an unparalleled footwear experience. Our
                                    commitment to excellence is evident in every
                                    pair of shoes we offer. Each design is a
                                    masterpiece, meticulously crafted by our
                                    skilled artisans who ensure that every
                                    stitch and detail is executed with precision
                                    and care.
                                </p>
                                <p>
                                    We source only the finest materials from
                                    trusted suppliers, guaranteeing durability,
                                    comfort, and style in every pair. Whether
                                    you're stepping out for a special occasion
                                    or seeking everyday comfort, our dedicated
                                    team is here to understand your needs and
                                    provide custom designs that speak to your
                                    style.
                                </p>
                                <Link to={"/about"}>
                            ...
                            <div className="company">
                                ...
                                <div className="sub__company">
                                    ...
                                    <div className=" profile_quote">
                                        <p>
                                            Nike Air Max 2017 features
                                            full-length cushioning and a sleek,
                                ...
                                <div className="sub__company">
                                    ...
                                    <div className=" profile_quote">
                                        <p>
                                            Vans Authentic SF in white offers a
                                            classic, minimalist style with a
                                ...
                                <div className="sub__company">
                                    ...
                                    <div className=" profile_quote">
                                        <p>
                                            Epic Adidas embodies athletic
                                            excellence and innovation, merging
                                            performance with iconic style for
                                            all.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="sub__company">
                                    ...
                                    <div className="profile_quote">
                                        <p>
                                            Giày sneakers unisex cổ thấp Fenty
                                            Creepe
                                        </p>
                                    </div>
                                </div>
