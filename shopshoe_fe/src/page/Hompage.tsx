        ...
        <div className="row">
          ...
          <div className="content p-4">
            ...
            <p>
              ...
              footwear experience. Our commitment to excellence is evident in
              every pair of shoes we offer. Each design is a masterpiece,
              meticulously crafted by our skilled artisans who ensure that every
              stitch and detail is executed with precision and care.
            </p>
            <p>
              We source only the finest materials from trusted suppliers,
              guaranteeing durability, comfort, and style in every pair. Whether
              you're stepping out for a special occasion or seeking everyday
              comfort, our dedicated team is here to understand your needs and
          ...
          <div className="company">
            ...
            <div className="sub__company">
              ...
              <div className=" profile_quote">
                <p>
                  Nike Air Max 2017 features full-length cushioning and a sleek,
            ...
            <div className="sub__company">
              ...
              <div className="profile_detail">
                ...
                <span style={{ marginLeft: "57px" }}>Authentic Trang SF</span>
              </div>
              <div className=" profile_quote">
                <p>
                  Vans Authentic SF in white offers a classic, minimalist style
                  with a comfortable, durable design.
                </p>
              </div>
            </div>
            {/* 3 */}
