                ...
                >
                    <div className="box_table_products">
                        ...
                        <div className="body_table_products p-3 bg-white">
                                                            ...
                                                            (
                                                                ...
                                                                <option
                                                                    ...
                                                                    disabled={
                                                                        ...
                                                                        (status !==
                                                                            "Cancelled" && // Loại trừ "Đã hủy" khỏi điều kiện nhảy cóc
                                                                            statusIndex >
                                                                                statusList.indexOf(
                                                                                    order.status
                                                                                ) +
                                                                                    1) || // Chặn nhảy cóc qua trạng thái tiếp theo
                                                                        (status ===
                                                                            "Goodsreceived" &&
                                                                            true) // Vẫn giữ điều kiện cũ cho "Goodsreceived"
                                                                    }
                                                                    style={{
                                                                        color:
                                                                            statusIndex <
                            ...
                            <Pagination
                                count={Math.ceil(
                                    filteredOrders.length / productsPerPage
                                )}
                                page={currentPage}
