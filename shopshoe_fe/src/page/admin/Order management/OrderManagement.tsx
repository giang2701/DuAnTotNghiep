...
const OrderManagement = () => {
  ...
  const handleStatusChange = async (orderId: string, newStatus: string) => {
    ...
    if (selectedOrder?.status === "Confirmed" && newStatus !== "Shipping") {
      toast.warning("Không thể thay đổi trạng thái khi xác nhận");
      return;
    }

    if (selectedOrder?.status === "Delivered" && newStatus !== "Completed") {
      toast.warning("Không thể thay đổi trạng thái khi vận chuyển");
      return;
    }
    if (
      ...
      toast.warning("Không thể thay đổi trạng thái khi đã nhận được hàng");
      return;
    }
                          ...
                          {[
                            ...
                            <option
                              ...
                              disabled={
                                ...
                                (status === "Goodsreceived" && true) // Thêm điều kiện này
                              }
                              style={{
                                color:
                                  statusIndex < statusList.indexOf(order.status)
                                    ? "gray"
                                    : "black",
                                opacity:
                                  statusIndex < statusList.indexOf(order.status)
