...
const UserList = () => {
  ...
  useEffect(() => {
    (async () => {
      ...
      setFilteredUsers(data.data.filter((user: User) => user.level !== "boss")); // Lọc bỏ 'boss'
    })();
  }, []);
  ...
  useEffect(() => {
    let filtered = user.filter(
      (item) =>
        item.username?.toLowerCase().includes(searchTerm.toLowerCase()) || // Tìm kiếm theo tên người dùng
                  ...
                  >
                    ...
                    {showRoleFilter && (
                      ...
                      >
                        ...
                        <p onClick={() => applyRoleFilter("admin")}>Admin</p>
                        <p onClick={() => applyRoleFilter("member")}>Member</p>
                        <p onClick={() => applyRoleFilter("")}>Tất cả</p>
                      </div>
                    )}
                  </button>
            ...
            <table className="table table-bordered table-striped">
              <thead className="text-center">
                <tr>
                  ...
                  {level === "boss" && <th>Quyền truy cập</th>}
