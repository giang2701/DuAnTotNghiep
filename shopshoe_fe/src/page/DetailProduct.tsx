...
const DetailProduct = () => {
  ...
  const [selectedSize, setSelectedSize] = useState<Size | null | string>(null); // ẩn hiện khi hết stock có trong size
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        setSizeNames(sizeNamesById.filter((size) => size !== null) as any[]);
      } catch (error) {
  ...
  return (
    <div className="container">
      <div className="row row__detail">
        {/* đường dẫn */}
        <Breadcrumbs className="mt-3 mb-5 mr-3 link" aria-label="breadcrumb">
        ...
        <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 information_detailproduct">
          ...
          <div className="d-flex align-items-center">
            ...
            <span className="p-1 mt-0 me-4 fs-3">{product.brand?.title}</span>
