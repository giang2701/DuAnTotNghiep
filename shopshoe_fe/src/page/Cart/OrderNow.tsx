...
const CheckoutNow = () => {
    ...
    const productDataNow = {
        product: productData.id, quantity: productData.quantity, size: productData.size.id
    }
    useEffect(() => {
    ...
    const handPayment = async () => {
        ...
        try {
            ...
            if (selectedValue === "MOMO") {
                ...
                response = await axios.post("http://localhost:8000/api/orders/detail", orderData);
                    ...
                    <Grid item xs={12} md={6}>
                        ...
                        >
                            ...
                            >
                                ...
                                <Typography>{formatPrice(totalPriceNow)} </Typography>
                            </Grid>
                            <Grid
                                container
                                justifyContent="space-between"
