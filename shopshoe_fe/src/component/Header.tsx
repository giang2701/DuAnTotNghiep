...
-32 7 25 20 36 40 20 38 -5 0 -32 -9 -62 -21z"
          ...
          <div className="menu__sub__header">
            {category.map((cate, index) => (
              <p key={index} onClick={() => handleGenderSelection(cate.title)}>
                {cate.title}
              </p>
            ))}
            {/* <p>Blog</p> */}
  ...
  >
    ...
    <input
      ...
      value={searchInput}
      onChange={(e) => setSearchInput(e.target.value)} // Cập nhật dữ liệu tìm kiếm
        ...
        filteredProducts.map((item, index) => (
          <div
            ...
            onClick={() => {
              ...
              navigate(`detail/${item._id}`); // Điều hướng tới trang chi tiết
            }}
          >
              ...
              <>
                <div className="menuUser" ref={menuRef}>
                  <i
                    ...
                    onClick={() => setHiddenUser(!hiddenUser)}
                  ></i>
                  <div
                    className={`menuUser-hidden ${hiddenUser ? "hidden" : ""}`}
                  >
                    {" "}
                    <Link to="/historyOrder" className="nav-link">
                      <p
              ...
              <form action="">
                ...
                >
                  <input
                    ...
                    style={{
                      width: "100%",
                      paddingRight: searchInput ? "35px" : "10px", // Tạo không gian cho dấu x khi cần
                      boxSizing: "border-box",
                    }}
                  />
...
-32 7 25 20 36 40 20 38 -5 0 -32 -9 -62 -21z"
            ...
            <div className="sub__menu-drawer">
              ...
              {category.map((cate, index) => (
                <p
                  key={index}
                  onClick={() => handleGenderSelection(cate.title)}
                >
                  {cate.title}
                </p>
              ))}
              {/* <p>Blog</p> */}
              <p>
                <Link to="/contact" className="link__home nav-link">
                  Contact
                </Link>
              </p>
              <p>
              ...
              {user ? (
                <>
                  <p>
                    <Link to="/historyOrder" className="link__home nav-link">
                      Đơn Hàng Của Tôi
                    </Link>
                  </p>
                </>
